...
$ret=mysqli_query($con,"insert into courseenrolls(studentRegno,pincode,department,level,course) values('$studentregno','$pincode','$department','$level','$course')");
if($ret)
{
...
<?php } ?>
    ...
    <span courseName="course-availability-status1" style="font-size:12px;">
  </div>
